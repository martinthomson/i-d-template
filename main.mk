...
concat3 = $(call concat,$(1),$(call concat,$(2),$(3)))
concat5 = $(call concat3,$(1),$(2),$(call concat3,$(3),$(4),$(5)))
...
$$(call arg,1,$(1)): $$(call arg,2,$(1)) $$(call arg,3,$(1))
	-$(rfcdiff) --html --stdout $$^ > $$@
endef
diff_deps := $(call concat3,$(draft_diffs),$(drafts_next_txt),$(drafts_prev_txt))
...
prev_versions_args := $(call concat5,$(drafts_prev_out),$(drafts_prev),$(drafts_prev_in),$(drafts_prev_txt),$(drafts_prev_xml))
