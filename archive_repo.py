...
valid_magic = ["B8n2c@e8kvfx", "E!vIA5L86J2I"]
refresh_prs = ["B8n2c@e8kvfx"]
        ...
        with open(args.refFile, "r") as ref_file:
            ...
            for element in ("magic", "timestamp", "issues", "repo"):
                if element not in raw_reference:
                    fileIsValid = False
                    break
            if not fileIsValid or raw_reference["magic"] not in valid_magic:
            ...
            if fileIsValid:
                ...
                if (
                    "pulls" in raw_reference
                    and raw_reference["magic"] not in refresh_prs
                ):
